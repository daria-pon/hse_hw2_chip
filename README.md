...
# Бонусная часть  
ngs-plot для образцов ENCFF870GXD.bam (result) и ENCFF409PGL.bam (result_1) загружены в общую папку.  
